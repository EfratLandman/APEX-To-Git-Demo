...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(363994335735350008)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1818817486678409798)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1818816931666409797)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18800245192526151)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18800719071526152)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18801222404526152)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18801755041526153)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18802271694526153)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(18801222404526152)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1818817486678409798)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18802682226526154)
,p_plugin_attribute_id=>wwv_flow_imp.id(18802271694526153)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18803295173526155)
,p_plugin_attribute_id=>wwv_flow_imp.id(18802271694526153)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18803943548526155)
,p_plugin_attribute_id=>wwv_flow_imp.id(18802271694526153)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18804509287526156)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(18802271694526153)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18805065180526156)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18805537760526157)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18806029591526157)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18806508012526158)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18806993130526158)
,p_plugin_attribute_id=>wwv_flow_imp.id(18806508012526158)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18807611628526159)
,p_plugin_attribute_id=>wwv_flow_imp.id(18806508012526158)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18808203723526160)
,p_plugin_attribute_id=>wwv_flow_imp.id(18806508012526158)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18808874605526160)
,p_plugin_attribute_id=>wwv_flow_imp.id(18806508012526158)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18809457149526161)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(18801755041526153)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1818816931666409797)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18809975847526161)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18810312877526162)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18810793428526162)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18811281401526163)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18811880317526163)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18812354389526164)
,p_plugin_attribute_id=>wwv_flow_imp.id(18811880317526163)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18812910901526164)
,p_plugin_attribute_id=>wwv_flow_imp.id(18811880317526163)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18813561475526165)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18813997035526165)
,p_plugin_attribute_id=>wwv_flow_imp.id(18813561475526165)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18814608354526166)
,p_plugin_attribute_id=>wwv_flow_imp.id(18813561475526165)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18815248253526167)
,p_plugin_attribute_id=>wwv_flow_imp.id(18813561475526165)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18815782679526168)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18816334436526168)
,p_plugin_attribute_id=>wwv_flow_imp.id(18815782679526168)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18816927783526169)
,p_plugin_attribute_id=>wwv_flow_imp.id(18815782679526168)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18817491086526169)
,p_plugin_attribute_id=>wwv_flow_imp.id(18815782679526168)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18818152184526170)
,p_plugin_attribute_id=>wwv_flow_imp.id(18815782679526168)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18818739843526171)
,p_plugin_attribute_id=>wwv_flow_imp.id(18815782679526168)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18819314382526171)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(18819853589526172)
,p_plugin_attribute_id=>wwv_flow_imp.id(18819314382526171)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(18820441764526172)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2164215974638380285)
,p_plugin_id=>wwv_flow_imp.id(363994335735350008)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
