...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(15027397143602733333)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18364935931525716)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18365448225525716)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18365912458525717)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18366399423525717)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18366897133525717)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18367396525525718)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18367946130525718)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18368460269525719)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18368951068525719)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18369463525525719)
,p_page_template_id=>wwv_flow_imp.id(15027397143602733333)
