...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(14865403876311396621)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18344808500525698)
,p_page_template_id=>wwv_flow_imp.id(14865403876311396621)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18345324434525698)
,p_page_template_id=>wwv_flow_imp.id(14865403876311396621)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18345831443525699)
,p_page_template_id=>wwv_flow_imp.id(14865403876311396621)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18346367622525699)
,p_page_template_id=>wwv_flow_imp.id(14865403876311396621)
,p_name=>'Body Footer'
