...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(363759752588349818)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18562757797525901)
,p_plug_template_id=>wwv_flow_imp.id(363759752588349818)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18563254910525901)
,p_plug_template_id=>wwv_flow_imp.id(363759752588349818)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18563705946525902)
,p_plug_template_id=>wwv_flow_imp.id(363759752588349818)
,p_name=>'Button Start'
