...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(14865437668530396671)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18569569781525907)
,p_plug_template_id=>wwv_flow_imp.id(14865437668530396671)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18570076932525908)
,p_plug_template_id=>wwv_flow_imp.id(14865437668530396671)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18570564027525908)
,p_plug_template_id=>wwv_flow_imp.id(14865437668530396671)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18571023987525909)
,p_plug_template_id=>wwv_flow_imp.id(14865437668530396671)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18571570302525909)
,p_plug_template_id=>wwv_flow_imp.id(14865437668530396671)
,p_name=>'Sub Regions'
