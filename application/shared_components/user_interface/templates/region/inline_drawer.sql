...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(309009815577390985)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18532885135525874)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18533470005525874)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18533912255525874)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18534433543525875)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18534928975525875)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18535439639525876)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18535913109525876)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18536430672525876)
,p_plug_template_id=>wwv_flow_imp.id(309009815577390985)
,p_name=>'Sub Regions'
