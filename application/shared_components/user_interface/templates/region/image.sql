...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(524130742001877199)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18506034115525849)
,p_plug_template_id=>wwv_flow_imp.id(524130742001877199)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(18506575207525849)
,p_plug_template_id=>wwv_flow_imp.id(524130742001877199)
,p_name=>'Sub Regions'
