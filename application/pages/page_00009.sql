...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(1619400112835900089)
,p_plug_name=>'Buttons'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17806579842038345321)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(17808677040575653326)
,p_plug_name=>'Audit Information'
,p_parent_plug_id=>wwv_flow_imp.id(17806579842038345321)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17806580165851345330)
,p_button_sequence=>30
,p_button_plug_id=>wwv_flow_imp.id(1619400112835900089)
,p_button_name=>'SAVE'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17806580052040345330)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17806580449384345333)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(17806580246903345330)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17806581243914345360)
,p_name=>'P9_ID'
,p_item_sequence=>1
,p_item_plug_id=>wwv_flow_imp.id(17806579842038345321)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17806581441937345380)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17808677849578655871)
,p_name=>'P9_CREATED'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17808677040575653326)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17808678723737657879)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17808679732741660506)
,p_name=>'P9_UPDATED'
,p_item_sequence=>50
,p_item_plug_id=>wwv_flow_imp.id(17808677040575653326)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17808680742091663195)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(17841958550600845127)
,p_name=>'P9_IS_ACTIVE'
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(17806579842038345321)
,p_use_cache_before_default=>'NO'
...
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(15069034877708037006)
...
,p_associated_item=>wwv_flow_imp.id(17806581441937345380)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_validation(
 p_id=>wwv_flow_imp.id(17834565625749255943)
...
,p_when_button_pressed=>wwv_flow_imp.id(17806580246903345330)
,p_associated_item=>wwv_flow_imp.id(17806581441937345380)
,p_error_display_location=>'INLINE_WITH_FIELD_AND_NOTIFICATION'
);
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(1619400189662900090)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(17806580449384345333)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(1619400340638900091)
,p_event_id=>wwv_flow_imp.id(1619400189662900090)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17806581964689345388)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17806582148734345390)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17806582351448345390)
,p_process_sequence=>40
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'reset page'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_process_when_button_id=>wwv_flow_imp.id(17806580246903345330)
,p_internal_uid=>17798879870386718574
);
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(1619400421942900092)
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(17805989112087929943)
,p_process_sequence=>50
